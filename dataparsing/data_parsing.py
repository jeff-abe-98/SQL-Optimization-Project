...
def extract_feature(elem, features, include_key=False):
    ...
    if include_key:
        attribs = {'mdate': [elem.attrib['mdate']]}
    else:
        attribs = {}
...
def main():
    ...
    try:
        ...
        exit()
    parse_article(dblp_path, 'dataset/article.csv', save_to_csv=True)
    parse_publications(dblp_path, 'dataset/publications.csv', save_to_csv=True)
    parse_book(dblp_path, 'dataset/book.csv', save_to_csv=True)
    parse_proceedings(dblp_path, 'dataset/proceedings.csv', save_to_csv=True)
    parse_inproceedings(dblp_path, 'dataset/inproceedings.csv', save_to_csv=True)
    parse_author(dblp_path, 'dataset/author.csv', save_to_csv=True)
